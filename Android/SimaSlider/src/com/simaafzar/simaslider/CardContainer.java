...
import com.simaafzar.simaslider.Orientations.Orientation;

import java.util.Random;

@SuppressLint("NewApi") public class CardContainer extends AdapterView<ListAdapter> {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		Log.d("Touch Event", MotionEvent.axisToString(event.getActionMasked()) + " ");
