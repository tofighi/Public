...
public class FindMyPhone extends Service{
	...
	private void registerReceivers() {
		registerReceiver(LocReceiver,
		        new IntentFilter("com.simaafzar.TextGPSLocation.ACTION_LOCATION"));
	...
	private BroadcastReceiver LocReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			try {
				...
				Toast.makeText(getApplicationContext(), R.string.message_sent,
	...
	private BroadcastReceiver SMSReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
	        ...
	        for (SmsMessage msg : sms) {
	        	...
	        	if (msg.getMessageBody().toString().equals("findme")) {
